"""
Django settings for Elsie_Final project.
...
SECRET_KEY = '^9-+_wmxlovvjkv!nb#)vyn7avv6h1zu0#5a36h^0cz2gb!3iw'
...
WSGI_APPLICATION = 'Elsie_Final.wsgi.application'
